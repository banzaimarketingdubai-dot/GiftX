              ...
              <div className="space-y-2.5">
                ...
                <div className="p-3 rounded-xl bg-[#242f3d]/60 border border-white/5">
                  ...
                  <p className="text-slate-400 text-[11px]">
                    ...
                    <br />• **🥈 Серебряный бокс**: чек от 300,000 VND (3 карты: 2 серебряных + 1 золотая)
                    <br />• **🥇 Золотой бокс**: чек от 600,000 VND (4 карты: 1 серебряная + 2 золотых + 1 платиновая)
                    <br />• **💎 Платиновый бокс**: чек от 1,000,000 VND (5 карт: 1 серебряная + 2 золотых + 2 платиновых)
                  </p>
                </div>
