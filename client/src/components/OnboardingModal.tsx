  ...
  const steps = [
    {
      ...
      badge: 'ШАГ 1 ИЗ 4',
      title: 'Отдыхайте в заведениях',
      subtitle: 'Посещайте рестораны, СПА, бары и сервисы партнеров сети GiftX.',
      description: 'Совершайте привычные покупки и заказы. Чем выше чек — тем ценнее подарочный бокс!',
      illustration: '🏖️ 🍸 💆‍♀️ 🛵'
    },
    {
      icon: QrCode,
      ...
      badge: 'ШАГ 2 ИЗ 4',
      title: 'Сканируйте QR у официанта',
      subtitle: 'При оплате счёта попросите официанта показать QR-код GiftX.',
      description: 'Наведите камеру смартфона или отсканируйте код через сканер Telegram — это займёт всего 3 секунды!',
      illustration: '📲 ⚡️ 🧾'
    },
    {
      icon: Gift,
      ...
      badge: 'ШАГ 3 ИЗ 4',
      title: 'Тапайте и забирайте 5 подарков',
      subtitle: 'Тапните по 3D-коробке 3 раза для распаковки HappyBox!',
      description: 'Вам мгновенно вылетит веер из 5 подарочных ваучеров (бесплатные напитки, скидки до 30% и деньги на счёт) в ДРУГИЕ заведения города.',
      illustration: '🎁 🎉 ✨ 🎟️'
    },
    {
      icon: Sparkles,
      ...
      badge: 'ФИНАЛ',
      title: 'Показывайте ваучер на кассе',
      subtitle: 'Открывайте раздел "Мои Подарки" и получайте бесплатные услуги!',
      description: 'Каждый ваучер содержит уникальный QR-код для гашения в партнерских заведениях. Экономьте и открывайте лучшие места!',
      illustration: '💎 🥂 ⭐️ 🏆'
    }
  ];
