  ...
  return (
    <div className="p-4 max-w-md mx-auto min-h-screen pb-24 text-slate-100 space-y-4 font-sans">
      ...
      {isStaff && staffInfo?.partner && (() => {
        ...
        return (
        <div className="bg-[#17212b] p-4.5 rounded-2xl border border-white/5 space-y-4 shadow-md">
          <div className="flex items-center justify-between border-b border-white/5 pb-3">
            <div className="flex items-center space-x-3">
              <VenueAvatar
                logoUrl={staffInfo.partner.logoUrl}
                name={staffInfo.partner.name}
                className="w-12 h-12 rounded-xl border border-white/10 shrink-0 shadow-md"
              />
              <div>
                <span className="text-[9px] uppercase font-bold tracking-widest text-[#2aabee] block">
                  Ваше Заведение
                </span>
            ...
            <span className="px-2.5 py-1 rounded-full bg-[#2aabee]/15 border border-[#2aabee]/30 text-[#2aabee] font-bold text-xs">
              {staffInfo.role}
            </span>
          </div>

          {/* ── Revoo Direct WebApp Link Block (ТЕЛЕГРАМ СТИЛЬ) ── */}
          <div className="p-3.5 rounded-xl bg-[#242f3d] border border-white/5 space-y-2.5 shadow-sm">
            <div className="flex items-center space-x-2">
              <div className="w-7 h-7 rounded-lg bg-[#2aabee]/15 border border-[#2aabee]/30 flex items-center justify-center shrink-0">
                <Link className="w-3.5 h-3.5 text-[#2aabee]" />
              </div>
              <div>
                <span className="text-[9px] uppercase font-bold tracking-widest text-[#2aabee] block">Revoo — WebApp Ссылка Заведения</span>
                <span className="text-[10px] text-slate-400">Прямой URL для открытия в браузере (аналог QR)</span>
              </div>
            </div>

            {/* Direct WebApp Link preview */}
            <div className="flex items-center space-x-2 bg-[#17212b] rounded-lg px-3 py-2 border border-white/5">
              <span className="text-[10px] text-[#2aabee] font-mono truncate flex-1 select-all">{revooWebAppLink}</span>
            </div>
            ...
            <div className="flex space-x-2">
              <button
                ...
                className={`flex-1 py-2 px-3 rounded-xl text-[11px] font-bold flex items-center justify-center space-x-1.5 transition-all cursor-pointer active:scale-95 ${
                  revooLinkCopied
                    ? 'bg-emerald-500/20 border border-emerald-500/40 text-emerald-400'
                    : 'bg-[#17212b] border border-white/10 text-slate-200 hover:text-white'
                }`}
              >
                {revooLinkCopied ? (
              ...
              <a
                ...
                className="py-2 px-3 rounded-xl bg-[#2aabee] hover:bg-[#229ed9] text-white text-[11px] font-bold flex items-center justify-center space-x-1.5 transition-all active:scale-95 shadow-md shadow-[#2aabee]/30 cursor-pointer"
              >
            ...
            <div className="pt-2 border-t border-white/5 flex items-center justify-between text-[10px]">
              ...
              <button
                ...
                className="text-[#2aabee] hover:text-cyan-300 font-bold flex items-center space-x-1 underline cursor-pointer"
              >
          ...
          <div className="space-y-2 pt-1">
            ...
            {(staffInfo.role === 'OWNER' || staffInfo.role === 'MANAGER') && (
              <>
                <button
                  ...
                  className="w-full p-3.5 rounded-xl bg-[#2aabee] hover:bg-[#229ed9] text-white font-extrabold text-xs flex items-center justify-between transition-all shadow-md shadow-[#2aabee]/30 cursor-pointer active:scale-[0.99]"
                >
                ...
                <button
                  ...
                  className="w-full p-3.5 rounded-xl bg-[#242f3d] hover:bg-[#2b394a] border border-white/5 text-slate-100 font-bold text-xs flex items-center justify-between transition-all shadow-sm cursor-pointer active:scale-[0.99]"
                >
                  <div className="flex items-center space-x-2.5">
                    <TrendingUp className="w-4 h-4 text-[#2aabee]" />
            ...
            <button
              ...
              className="w-full p-3.5 rounded-xl bg-[#242f3d] hover:bg-[#2b394a] border border-white/5 text-slate-100 font-bold text-xs flex items-center justify-between transition-all cursor-pointer active:scale-[0.99]"
            >
              <div className="flex items-center space-x-2.5">
            ...
            {staffInfo?.id?.startsWith('demo-') && (
              <button
                ...
                className="w-full mt-2 py-2 px-3 rounded-xl bg-red-500/10 hover:bg-red-500/20 border border-red-500/20 text-red-400 text-xs font-bold flex items-center justify-center space-x-1.5 transition-all cursor-pointer"
              >
      ...
      {!isStaff && (
        <div className="bg-[#17212b] p-4.5 rounded-2xl border border-white/5 space-y-4 shadow-md">
          <div className="flex items-center space-x-3">
            <div className="w-11 h-11 rounded-xl bg-[#2aabee]/15 border border-[#2aabee]/30 flex items-center justify-center text-[#2aabee] shrink-0 shadow-sm">
              <Building2 className="w-5 h-5 text-[#2aabee]" />
            </div>
            <div>
              <span className="text-[9px] uppercase font-bold text-[#2aabee] tracking-widest px-2 py-0.5 rounded-full bg-[#2aabee]/10 border border-[#2aabee]/20">
                GiftX B2B Сеть
              </span>
          ...
          <div className="space-y-2 pt-1">
            <button
              ...
              className="w-full py-3.5 rounded-xl bg-[#2aabee] hover:bg-[#229ed9] text-white font-extrabold text-xs flex items-center justify-center space-x-2 shadow-md shadow-[#2aabee]/30 transition-all cursor-pointer active:scale-[0.99]"
            >
            ...
            <button
              ...
              className="w-full py-3 rounded-xl bg-[#242f3d] hover:bg-[#2b394a] border border-white/5 text-[#2aabee] font-bold text-xs flex items-center justify-center space-x-2 transition-all cursor-pointer active:scale-[0.99]"
            >
              <Sliders className="w-4 h-4 text-[#2aabee]" />
            ...
            <button
              ...
              className="w-full py-3 rounded-xl bg-[#242f3d] hover:bg-[#2b394a] border border-white/5 text-slate-100 font-bold text-xs flex items-center justify-center space-x-2 transition-all cursor-pointer active:scale-[0.99]"
            >
              <QrCode className="w-4 h-4 text-[#2aabee]" />
      ...
      <div className="space-y-2">
        ...
        <button
          ...
          className="w-full p-3.5 rounded-xl bg-[#17212b] border border-white/5 text-slate-200 text-xs font-bold flex items-center justify-between hover:bg-[#1f2c3a] transition-all cursor-pointer shadow-sm"
        >
          <div className="flex items-center space-x-2.5">
            <TrendingUp className="w-4 h-4 text-[#2aabee]" />
        ...
        <button
          ...
          className="w-full p-3 rounded-xl bg-[#242f3d] border border-white/5 text-slate-400 text-xs font-bold flex items-center justify-center space-x-1.5 hover:text-slate-200 cursor-pointer"
        >
